    ...
    >
        ...
        <div className="group relative">
            ...
            <label htmlFor="image">
                ...
                src={
                image
                    ? URL.createObjectURL(image) // If user selects a new file, show preview
                    : user?.image || // If user already has an image, show that
                ...
                <div
                className="absolute hidden top-0 ring-0 left-0 bottom-0 bg-black/10 rounded-full group-hover:flex
        ...
        {image && (
        <button
          className="absolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer" onClick={updateImage} >
